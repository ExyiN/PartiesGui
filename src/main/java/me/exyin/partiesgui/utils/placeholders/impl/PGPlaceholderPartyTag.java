...
public class PGPlaceholderPartyTag implements PGPlaceholder {
  private final PartiesGui plugin;
  private final PartyPlayer partyPlayer;

  public PGPlaceholderPartyTag(final PartiesGui plugin, final PartyPlayer partyPlayer) {
    this.plugin = plugin;
  ...
  public String getReplacement() {
    ...
    assert party != null;
    return party.getTag() == null ? "" : party.getTag();
  }
}
