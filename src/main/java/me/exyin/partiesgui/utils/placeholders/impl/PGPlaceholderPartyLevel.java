...
public class PGPlaceholderPartyLevel implements PGPlaceholder {
  private final PartiesGui plugin;
  private final PartyPlayer partyPlayer;

  public PGPlaceholderPartyLevel(final PartiesGui plugin, final PartyPlayer partyPlayer) {
    this.plugin = plugin;
  ...
  public String getReplacement() {
    ...
    assert party != null;
    return String.valueOf(party.getLevel());
  }
}
