...
public class PGPlaceholderPartyLevelUpCurrent implements PGPlaceholder {
  private final PartiesGui plugin;
  private final PartyPlayer partyPlayer;

  public PGPlaceholderPartyLevelUpCurrent(final PartiesGui plugin, final PartyPlayer partyPlayer) {
    this.plugin = plugin;
  ...
  public String getReplacement() {
    ...
    assert party != null;
    return String.format(plugin.getConfigUtil().getString("decimal-format", "%.2f"), party.getLevelUpCurrent());
  }
}
