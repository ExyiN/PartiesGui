...
public class ClickEventPartyInvitations implements ClickEvent {
  private final PartiesGui plugin;

  public ClickEventPartyInvitations(final PartiesGui plugin) {
    this.plugin = plugin;
  }
  ...
  public void execute(final PGGui gui, final Player whoClicked, final PartyPlayer partyPlayer, final int slot) {
    ...
    final InvitationsGui inviteGui = new InvitationsGui(plugin, partyPlayer);
    whoClicked.openInventory(inviteGui.getInventory());
  }
